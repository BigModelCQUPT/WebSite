        ...
        <el-space wrap>
            <el-card  class="box-card" style="width: 550px">
                ...
                <div class="information">
                    <div  class="username">
                        <span>{{username}}</span>
                        <el-icon v-if="isCollapse" class="gender" isCollapse="isCollapse"><male /></el-icon>
                        <el-icon v-else class="gender" :isCollapse="isCollapse"><female /></el-icon>
                        <img   :src="require('../assets/'+img_url)" style="height: 70px; width: 70px; float: right" class="img-head">
                    </div>
                    <div>
                        ...
                        <div>
                            ...
                            <span class="key" style="margin-left: 10px">居住地</span> <span style="margin-right: 10px;">{{address}}</span> |
                            <span class="key" style="margin-left: 10px">年龄</span> <span style="margin-right: 10px;">{{age}}</span>
                        </div>
                        <div style="margin-top: 15px" >
                            <el-icon style="padding-right: 10px; float: left"><iphone /></el-icon>
                            <span style="margin-right: 15px">{{tel}}</span> |
                            <el-icon style="padding-left: 10px;"><message /></el-icon>
