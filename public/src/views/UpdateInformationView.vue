                ...
                <div class="input-information">
                    <div class="el-form-item__content">
                        <div class="el-input">
                            ...
                            <input v-model="name" style="width: 425px" autocomplete="off" placeholder="请输入你的真实姓名"
                                type="text" rows="2" maxlength="16" validateevent="true" class="el-input__inner">
                        </div>
                        <div class="el-input">
                        ...
                        <div class="el-input">
                            ...
                            <input v-model="position" style="width: 425px" autocomplete="off" placeholder="请输入你的职位"
                                type="text" rows="2" maxlength="16" validateevent="true" class="el-input__inner">
                        </div>
                        <div class="el-input">
                            <span class="el-form-item__label">出生日期:</span>
                            <el-date-picker v-model="birth" type="date" placeholder="请选择日期" style="width: 425px"
                        ...
                        <div class="el-input">
                            ...
                            <input v-model="address" style="width: 425px" autocomplete="off" placeholder="请输入你的家庭地址"
                                type="text" rows="2" maxlength="16" validateevent="true" class="el-input__inner">
                        </div>
                        <div class="el-input">
                            <label class="el-form-item__label">身份证号码:</label>
                            <input v-model="id_num" style="width: 425px" autocomplete="off" placeholder="请输入身份证号码"
                                type="text" rows="2" maxlength="18" validateevent="true" class="el-input__inner">
                        </div>
                        <div class="el-input">
                            <label class="el-form-item__label">电话号码:</label>
                            <input v-model="tel" style="width: 425px" autocomplete="off" placeholder="请输入你的电话号码"
                                type="text" rows="2" maxlength="11" validateevent="true" class="el-input__inner">
                        </div>
                        <div class="el-input">
                            <label class="el-form-item__label">邮箱:</label>
                            <input v-model="email" style="width: 425px" autocomplete="off" placeholder="请输入你的邮箱"
                                type="text" rows="2" maxlength="16" validateevent="true" class="el-input__inner">
                        </div>
                    </div>
                    <div style="margin-top: 20px;text-align: center; ">
                        <el-button type="primary" @click="updateInformation">&nbsp;&nbsp;&nbsp; 提交
                            &nbsp;&nbsp;&nbsp;</el-button>
                    </div>
                </div>
            </el-card>
