            ...
            <div>
                <div style="display: flex">
                    <div class="img1" style="width: 152px;">
                        <img style="width: 100%;" class="img1"
                            src="https://img.alicdn.com/tps/TB1Z8MHPFXXXXacaXXXXXXXXXXX-500-54.gif" alt="">
                    </div>
                ...
                <div class="middle-panel">
                    ...
                    <div style="color: white;display: flex; margin-top: 13px" v-for="item in into_infor" :key="item">
                        <div class="line row-content"
                            style="margin-left: 10px;height: 20px;text-overflow: ellipsis;overflow: hidden;vertical-align: middle; display: flex;align-items: center;background-color: rgba(0, 59, 81, 0);">

                            <div class="index"
                                style="display: inline-block;text-align: center;vertical-align: middle;width: 12.5%;color: #141313;font-size: 1px;">
                                <div class="index-bg"
                                    style="background-color: #f4ff00; font-weight: normal; width: 14.600000000000001px;height: 14.600000000000001px;line-height: 14.600000000000001px;vertical-align: middle;margin: auto;border-radius: 7.300000000000001px;text-align: center;">
                                </div>
                            </div>
                            <div class="column cell-content"
                                style="width: 50%;display:inline-block;text-align: center;white-space: nowrap;overflow: hidden;vertical-align: middle;background-color: transparent;font-size: 12px;color: #ffffff;font-weight: normal;">
                                <div class="marquee-text" style="display: inline-block;">
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
                                        class="whiteSpace" style="display:inline-block;width:0;"></i>
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
                                        class="whiteSpace" style="display:inline-block;width:0;"></i>
                                </div>
                            </div>
                            <div class="column cell-content"
                                style="width: 25%;display:inline-block;text-align: center;white-space: nowrap;overflow: hidden;vertical-align: middle;background-color: transparent;font-size: 12px;color: #ffffff;font-weight: normal;">
                                <div class="marquee-text" style="display: inline-block;">
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
                                        class="whiteSpace" style="display:inline-block;width:0;"></i>
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
                            ...
                            <div class="column cell-content"
                                style="width: 15%;display:inline-block;text-align: center;white-space: nowrap;overflow: hidden;vertical-align: middle;background-color: transparent;font-size: 12px;color: #ffffff;font-weight: normal;">
                                <div class="marquee-text" style="display: inline-block;">
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
                                        class="whiteSpace" style="display:inline-block;width:0;"></i>
                                    <span style="display: inline-block;" class="marquee-text-span"></span><i
