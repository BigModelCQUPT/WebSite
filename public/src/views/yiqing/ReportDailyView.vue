        ...
        <el-space wrap>
            <el-card style="width: 750px;">
                ...
                <div style="margin-left: 20px;">
                    ...
                    <br>
                    <el-checkbox border class="check1-content" v-model="checked1" label="14天内曾居住或前往疫情高发地"
                        size="large" />
                    ...
                    <el-checkbox border class="check1-content" v-model="checked3" label="感冒样症状:乏力、精神差、咳嗽、发烧、肌肉痛、头痛"
                        size="large" />
                </div>
                <el-divider />
