...
<template>
    <div style="margin-left: 10px; margin-top: -25px;margin-right: 10px">
        ...
        <div class="toolbar">
            <div>
                <el-input clearable @clear="init_page" @keydown.enter="findPeople" class="el-input-resident"
                    v-model="search_name" placeholder="请输入隔离人员名称进行搜索...">
                </el-input>
                ...
                <el-table-column fixed="right" label="操作" width="135">
                    <template v-slot="scope">
                        ...
                        <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" icon-color="red"
                            title="确定删除该条信息吗" @confirm="deleteItem(scope.row)" @cancel="cancleDelete()">
                            <template #reference>
        ...
        <div>
            <el-dialog title="添加居民信息" width="50%" v-model="dialogVisible"
                ...
                <div style="height: 300px">
                    ...
                    <el-input :placeholder=" '请输入' + informationItem[index]" v-for="(val, key, index) in information"
                        :key="index" v-show="activeindex == index"
                        style="float: right; width: 400px; margin-top: -150px" v-model="information[key]"
                        @keydown.enter="nextStep"></el-input>
                </div>
            ...
            <el-dialog title="编辑隔离人员信息" width="50%" v-model="editdialogVisible"
                style="display: flex; justify-content: space-around; align-items: center">
                <div style="height: 300px">
                    <el-steps direction="vertical" :active="activeindex">
                        <el-step :title="item" v-for="(item,index) in informationItem" :key="index" />
