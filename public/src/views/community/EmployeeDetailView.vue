<template>
    <div style="margin-top: 30px">
        <table width="70%" cellspacing="0" border style="margin: auto;">
            <tbody>
                <tr>
                    <td rowspan="3" align="center" style="padding:5px 10px;"><el-image
                            :src="require('../../assets/'+img)" width="116" height="153" title=""
                            class=" _681a23b0649e61ca572cb5bb8db206ec" alt="图片" /></td>
                ...
                <tr>
                    ...
                    <td style="padding:5px 10px;">
                        <p style="text-align: left; text-indent: 2em;">{{introduction}}</p>
