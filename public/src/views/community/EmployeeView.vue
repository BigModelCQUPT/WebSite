<template>
    <div style="width: 70%; margin: auto; margin-top: -20px">
        ...
        <el-carousel :interval="2000" type="card" height="500px">
            <el-carousel-item v-for="(item, index) in userInfo" :key="item" style="background-color: white; "
                ...
                <div style="display:inline-flex; color: #3399ff">
                    ...
                    <div style="width: 70%">
                        <el-image class="img" :src="require('../../assets/'+userInfo[index].img)" alt="找不到"
                            :fit="cover" />
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            const _this = this
            axios.get('http://10.16.104.183:8181/employee/getInformation').then(function (resp) {
