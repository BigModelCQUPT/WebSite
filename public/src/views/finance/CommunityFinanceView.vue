<template>
    ...
    <div style="text-align: right; margin-right: 10px; margin-top: -10px">
        <el-select v-model="now_select" size="large" style="margin-right: 10px" @change="changeDate">
            <el-option v-for="item in options" :key="item" :value="item.date">
            </el-option>
    ...
    <div style="margin: 10px 10px 10px 10px">
        <el-card class="box-card">
            <el-table :data="tableData" border :summary-method="getSummaries01" show-summary style="width: 100%;"
                height="410px">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init() {
                const _this = this
                axios.get('http://10.16.104.183:8181/communityFinance/get/' + this.now_select).then(function (resp) {
