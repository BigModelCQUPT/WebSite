                ...
                <tbody>
                    <tr style="height: 35px">
                        <td rowspan="3" align="center" style="padding:5px 10px;">
                            <el-image :src="require('../../assets/'+form.img)" width="116" height="153" title=""
                                class=" _681a23b0649e61ca572cb5bb8db206ec" alt="图片" />
                            <el-upload v-if="form.img === null" list-type="picture-card" :auto-upload="false" :limit="1"
                                :on-exceed="tip" style="margin-bottom: 15px">
                                <el-icon>
                                    <Plus />
                                </el-icon>
                                <template #file="{ file }">
                        ...
                        <td width="60%">
                            <input v-model="form.name"
                                style="height: 35px;width: 100%; border: 0px; text-align: center" />
                        </td>
                    </tr>
                    <tr style="height: 35px">
                    ...
                    <tr style="height: 65px">
                        ...
                        <td>
                            <p>
                                <textarea type="text" v-model="form.introduce"
                                    style=" height: 65px; width: 98%; border: 0px; " />
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr style="height: 65px">
                        ...
                        <td>
                            <textarea type="text" v-model="form.work"
                                style=" height: 65px; width: 98%; border: 0px; " />
                        </td>
                    </tr>
                    <tr style="height: 35px">
