    ...
    <div style="width: 60%">
        <el-form ref="formData" :model="formData" style="margin-left: 100px; margin-right:20px">
            <el-form-item prop="member" label="介绍1">
                <el-input v-model="formData.p1" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入参会人员"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-form-item prop="member" label="介绍2">
                <el-input v-model="formData.p2" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入社区介绍"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-form-item prop="member" label="介绍3">
                <el-input v-model="formData.p3" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入社区介绍"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-form-item prop="member" label="介绍4">
                <el-input v-model="formData.p4" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入社区介绍"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-form-item prop="member" label="介绍5">
                <el-input v-model="formData.p5" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入社区介绍"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-form-item prop="member" label="介绍6">
                <el-input v-model="formData.p6" :autosize="{ minRows: 1 }" type="textarea" placeholder="请输入社区介绍"
                    style="margin-top: 8px" />
            </el-form-item>
            <el-upload list-type="picture-card" :auto-upload="false" :limit="6" :on-exceed="tip"
    ...
    export default {
        ...
        methods: {
            submitForm() {
                ...
                const _this = this
                axios.post('http://10.16.104.183:8181/community/edit', this.formData).then(function (resp) {
