    ...
    <div style="margin-top: -25px">
        <el-row >
            <el-form ref="formData" :model="formData" :rules="rules"  style="margin-left: 200px;">
                ...
                <el-form-item style="margin-top: 0px" prop="time"  label=" " >
                    ...
                    <div>
                        <el-time-picker
                                ...
                                style="width: 280px;margin-left: 10px; margin-top: 3px"
                        />
                    </div>
                </el-form-item>
                ...
                <el-form-item >
                    <el-button style="margin-left: 110px; width: 300px" type="primary" @click="submitForm">立即预订</el-button>
                </el-form-item>
            </el-form>
        </el-row>
    </div>
            ...
            submitForm(){
                ...
                this.$refs.formData.validate((valid) => {
                    if (valid) {
                        ...
                        // this.formData.name =
                        axios.post('http://localhost:8181/bookMeeting', this.formData).then(function (resp) {
                            // console.log(resp)
