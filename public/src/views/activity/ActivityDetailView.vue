                    ...
                    <tr style="height: 40px">
                        ...
                        <td class="in-td" colspan="3">
                            <input v-model="form.theme" type="text"
                                style="font-family: 华文楷体;font-size: 20px;font-weight: bolder;height: 40px; width: 100%; border: 0px; text-align: center">
                        </td>
                    </tr>
                    <tr style="height: 540px">
                        ...
                        <td class="in-td" colspan="3">
                            <textarea type="text" v-model="form.content"
                                style="font-size: 20px;height: 280px; width: 99%; border: 0px;margin-top: 0px"
                                readonly="readonly"></textarea>
                            <img style="margin-bottom: 0px; width: 300px; height: 300px; margin-right: 10px"
                                :src="require('../../assets/'+form.img)" alt="">
                        </td>
                    </tr>
                </table>
            </el-form>
