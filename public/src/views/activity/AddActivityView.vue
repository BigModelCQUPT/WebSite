                    ...
                    <tr style="height: 40px">
                        ...
                        <td class="in-td" style="width: 180px">
                            <input type="date" v-model="form.date"
                                style=" height: 100%; width: 100%; border: 0px; text-align: center" />
                        </td>
                        <td class="in-td" style="width: 150px">参加人数</td>
                        <td class="in-td" style="width: 130px">
                            <input v-model="form.number" type="text"
                                style="height: 40px; width: 100%; border: 0px; text-align: center">
                        </td>
                    </tr>
                    <tr style="height: 40px">
                        <td class="in-td">活动地点</td>
                        <td class="in-td">
                            <input v-model="form.address" name="name" type="text"
                                style="height: 40px; width: 100%; border: 0px; text-align: center">
                        </td>
                    ...
                    <tr style="height: 540px">
                        ...
                        <td class="in-td" colspan="3">
                            <textarea type="text" v-model="form.content"
                                style=" height: 330px; width: 99%; border: 0px;margin-top: -80px"></textarea>
